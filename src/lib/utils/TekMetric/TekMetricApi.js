...
const getAllShops = async (accessToken) =>
{
...
const createCustomer = async (accessToken) =>
{
...
const createVehicle = async (accessToken) =>
{
...
const createAppt = async (accessToken) =>
{
...
export { getToken, getAllShops, getCustomer, createCustomer, getVehicles, createVehicle, getAppts, createAppt }