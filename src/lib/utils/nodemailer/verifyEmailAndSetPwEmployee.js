...
const verifyEmailAndSetPwEmployee = (name, email, token) =>
{
  ...
  async function main ()
  {
    ...
    const info = await transporter.sendMail({
      ...
      subject: "You Have Been Invite To Leads Near Me®", // Subject line
      text: "Verification Enclosed!", // plain text body
      html: `
      <div style='width: 50%;'>
        <p>Dear, ${ name }</p>
        <p>
...
export default verifyEmailAndSetPwEmployee