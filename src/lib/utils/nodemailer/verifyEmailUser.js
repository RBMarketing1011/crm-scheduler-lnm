...
const verifyEmailUser = (name, email, token) =>
{
  ...
  async function main ()
  {
    ...
    const info = await transporter.sendMail({
      ...
      <div style='width: 50%;'>
        ...
        <br>
        <a href='${ process.env.NEXT_PUBLIC_API_DOMAIN }/users/verification/${ token }' style='background: #EF5124; padding: 1rem 3rem; border-radius: .6rem; color: #ffffff; font-weight: bold; text-transform: uppercase; margin: 30px 0; text-decoration: none;'>
        Verify Email
        </a>
        <br>
        <br>
