...
export default function DeleteItemPopup ({ state, setState, item, data })
{
  ...
  const deleteItem = async () =>
  {
    try
    {
      const result = await fetch(`${ data.url }`, {
        ...
        body: JSON.stringify({ id: data.id, accountId: data.accountId })
      })
  ...
  return (
    <Transition show={ state }>
      <Dialog className="relative z-[1000000]" onClose={ setState }>
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete the { item.toLowerCase() }? All of this data will be permanently removed
